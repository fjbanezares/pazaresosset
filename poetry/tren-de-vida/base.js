document.addEventListener('DOMContentLoaded', function () {
  ...
  if (langSelect) {
    langSelect.addEventListener('change', function () {
      ...
      const globalComicPath = 'comic/comic_tren.png';
      const imageMap = {
  ...
  window.addEventListener('scroll', function () {
    ...
    // Subtle tint 
    const r = Math.floor(scrollPercent * 15);
    const g = Math.floor(scrollPercent * 15);
    const b = Math.floor(scrollPercent * 15);
  ...
  // --- 3. Canvas Effects (Moving Train Effect - horizontal passing particles) ---
