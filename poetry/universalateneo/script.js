...
function updateLangUI(opt) {
    ...
    localStorage.setItem('ateneo_lang', lang);
}
...
const savedLang = localStorage.getItem('ateneo_lang');
if (savedLang) { 
...
// --- Particle Effects (Wisdom Stardust & Cosmic Glow) ---
...
class CosmicStardust {
    ...
    init() {
        ...
        this.speedY = (Math.random() - 0.5) * 0.15 - 0.08; // slow drift upwards
        this.pulseSpeed = Math.random() * 0.015 + 0.005;
        this.pulseOffset = Math.random() * Math.PI * 2;
        
        // Cosmic colors: gold, celestial sky blue, starry silver, royal indigo
        const colors = [
            'rgba(212,175,55,',  // Gold
            'rgba(56,189,248,',  // Sky Blue
            'rgba(203,213,225,', // Silver
            'rgba(148,163,184,'  // Starry Slate
        ];
