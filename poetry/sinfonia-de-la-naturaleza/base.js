document.addEventListener('DOMContentLoaded', function () {
    ...
    if (langSelect) {
        langSelect.addEventListener('change', function () {
            ...
            const globalComicPath = 'comic/comic_sinfonia.png';
            const imageMap = {
    ...
    window.addEventListener('scroll', function () {
        ...
        // Subtle tint 
        const r = Math.floor(scrollPercent * 5);
        const g = Math.floor(scrollPercent * 15);
        const b = Math.floor(scrollPercent * 5);

        // uncomment to apply subtle green tint over time
    ...
    // --- 3. Canvas Effects (Nature: Subtle glowing fireflies / spores) ---
    ...
    if (canvas) {
        ...
        class Firefly {
            ...
            reset() {
                ...
                // glowing green/yellow
                this.color = `rgba(${Math.floor(Math.random() * 50 + 150)}, 255, ${Math.floor(Math.random() * 50 + 100)}, `;
