...
function updateLangUI(opt) {
    ...
    localStorage.setItem('nochesueno_lang', lang);
}
...
const savedLang = localStorage.getItem('nochesueno_lang');
...
class Firefly {
    ...
    init() {
        ...
        const colors = ['rgba(200,184,122,','rgba(212,84,10,','rgba(255,200,100,','rgba(192,200,216,','rgba(58,58,140,'];
