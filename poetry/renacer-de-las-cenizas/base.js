...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // --- INICIO: CÓDIGO AÑADIDO PARA IDIOMA POR DEFECTO ---

  // 1. Oculta todos los elementos 'english' que tu HTML muestra por defecto
  ...
  // 3. Asegúrate de que el <select> muestre "Español" como seleccionado
  document.getElementById('language-select').value = 'spanish';

  // --- FIN: CÓDIGO AÑADIDO ---


  // Tu código original para cambiar el idioma cuando el usuario hace clic
